...
> {
  ...
  componentDidUpdate(prevProps, prevState, snapshot) {
    ...
    if (
      (Number.isInteger(prevProps.selectedId) &&
        prevProps.selectedId != this.props.selectedId) ||
      (Array.isArray(prevProps.selectedId) &&
        prevProps.selectedId.join(',') != this.props.selectedId.join(','))
    ) {
      this.initSelected();
    }
  }
